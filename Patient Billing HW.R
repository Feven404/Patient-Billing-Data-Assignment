...
df_new_patient_visit_information <- df_patient_visit_info[-c(1), ]
...
df_new_patient_visit_information<- df_new_patient_visit_information%>%
...
df_new_patient_visit_information$Month <- month(df_new_patient_visit_information$VisitDate, label = TRUE)
